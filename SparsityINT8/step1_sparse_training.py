...
def train_sparse(model, args, criterion, data_loader, data_loader_test, data_loader_val):
    ...
    prune_trained_model_custom(
        model_sparse, optimizer, allow_permutation=args.allow_permutation, allow_recompute_mask=True
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Dataset to be used during training." " If None, take the entire train data. Otherwise, take subset.",
    )
    parser.add_argument(
        "--test_data_size",
        type=int,
    ...
    # Sparse params
    parser.add_argument("--sparse_epoch", type=int, default=30, help="Number of epochs to fine-tune Sparse model.")
    parser.add_argument(
        "--sparse_steps_per_epoch",
        type=int,
        default=None,
    ...
    parser.add_argument(
        ...
        default="constant",
        type=str,
        help="LR Scheduler, options={multistep, constant, step}",
    )
    parser.add_argument(
        "--lr_warmup_epochs",
        default=5,
    ...
    parser.add_argument(
        "--rewrite_sparse_weights",
        dest="rewrite_sparse_weights",
        action="store_true",
        help="Rewrite Sparse checkpoint if it exists.",
    )
    parser.add_argument("--allow_permutation", action="store_true")
